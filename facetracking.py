...
parser.add_argument('--face_cascade', help="Path to face cascade.",
                    default="/usr/local/lib/python3.10/site-packages/cv2/data/haarcascade_frontalface_alt.xml")
# parser.add_argument('--eyes_cascade', help='Path to eyes cascade.',
#                     default='data/haarcascade_eye_tree_eyeglasses.xml')
parser.add_argument('--eyes_cascade', help="Path to eyes cascade.",
                    default="/usr/local/lib/python3.10/site-packages/cv2/data/haarcascade_eye_tree_eyeglasses.xml")
parser.add_argument(
